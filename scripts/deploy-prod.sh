...
start_production() {
    ...
    if [ $? -eq 0 ]; then
        ...
        print_status "Web application will be available at: https://books.srijansahay05.in"
        print_status "Admin panel will be available at: https://books.srijansahay05.in/admin"
...
setup_ssl() {
    ...
    if ! grep -q "books.srijansahay05.in" .env.prod; then
